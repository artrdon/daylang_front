      ...
      //  if (e) e.preventDefault();
       // const startTime = performance.now();
        ...
        try {
            ...
            const response = await axios.post(`${env.VITE_APIURL}/airequestdemo/`, formData, {
                headers: {
        ...
        <div className='ai_speak_what_he_said_panel_div' style={{left: 0, zIndex: 1101}}> 
            <div style={{overflow: "auto", height: "100%"}}>
                ...
                <div className='ai_speak_settings_div'>
                    ...
                    <input type="range" value={tokens} min={10} max={200} onChange={handleTokensChange} className='ai_speak_settings_reguling'/>
